...
import { ArrowLeft, Copy, ExternalLink, TrendingUp, Users, Eye, MousePointer, Zap } from "lucide-react";
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Badge variant="outline">
            ...
            {calculateViralScore(generation)}/10 Viral Score
          </Badge>
        </div>
      </div>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button 
                  variant="outline" 
                  size="sm" 
                  onClick={() => handleCopy(`**Hook:** ${generation.hook}\n\n**Script:**\n${generation.script}`)}
                >
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold text-sm text-muted-foreground uppercase tracking-wide">Hook</h4>
                  <Button 
                    variant="ghost" 
                    size="sm" 
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <h4 className="font-semibold text-sm text-muted-foreground uppercase tracking-wide">Full Script</h4>
                  <Button 
                    variant="ghost" 
                    size="sm" 
                ...
                <div className="bg-muted/50 rounded-lg p-4">
                  <div className="text-sm leading-relaxed whitespace-pre-wrap">{generation.script}</div>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">{formatNumber(generation.performance_data.views)}</p>
                  ...
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">{formatNumber(generation.performance_data.clicks)}</p>
                  ...
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">{generation.performance_data.ctr.toFixed(1)}%</p>
                  ...
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    ...
                    <p className="text-2xl font-bold">{generation.performance_data.engagement_rate.toFixed(1)}%</p>
                ...
                <div className="text-center p-4 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-lg border">
                  ...
                  <p className="text-3xl font-bold text-primary">{calculateViralScore(generation)}/10</p>
